...
\newacronym[description={\fc{A} format which language servers can emit to persist LSP-based information about a software project.},seealso=lsp]{lsif}{LSIF}{Language Server Index Format}
