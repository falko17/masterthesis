...
% Using my fork here until the PR regarding jitter is merged and released.
...
Finally, I want to thank all \fxerror*{Add proofreader names here}{proofreaders} who, despite its length, read through this thesis to catch any mistakes.
