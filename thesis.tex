...
% key, ylabel, ymin, ymax
\newcommand{\violinab}[4]{\violin{alphabeta}{$\alpha$}{$\beta$}{#1}{Group}{#2}{#3}{#4}}
\newcommand{\violinsv}[4]{\violin{seevs}{SEE}{VSCode}{#1}{System}{#2}{#3}{#4}}
\newcommand{\violinsus}{\violin{seevs-sus}{SEE}{VSCode}{sus}{System}{SUS}{40}{100}}
