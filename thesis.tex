...
% FIXME: Using my fork here until the PR regarding jitter is merged.
...
\newcommand{\violin}[9]{
  \begin{tikzpicture}
    ...
    \violinplot[%
      index=\expandafter#4\expandafter1,%
      col sep=tab,%
      color=Maroon,%
      dataset size=3pt,%
      average size=5pt,%
    ...
    \violinplot[%
      index=\expandafter#4\expandafter2,%
      col sep=tab,%
      color=black,%
      dataset size=3pt,%
      average size=5pt,%
