...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[fill] table [x=correct,y=occ1,col sep=tab] {analysis/dat/#1.dat};
    \addplot+[fill] table [x=correct,y=occ2,col sep=tab] {analysis/dat/#1.dat};
  \end{axis}
  \plotornaments{bars}
\end{tikzpicture}
}
...
\newcommand{\violin}[9]{
  \begin{tikzpicture}
    ...
    \violinplot[%
      ...
      label={#2}
    ]{analysis/dat/\expandafter#1\expandafter1.dat};
    ...
    \violinplot[%
      ...
      dataset fill opacity=0.5,%
      label={#3}
    ]{analysis/dat/\expandafter#1\expandafter2.dat};
...
\newcommand{\violinab}[6]{\violin{alphabeta}{$\Psi$}{$\Omega$}{#1}{#2}{#3}{#4}{#5}{#6}}
\newcommand{\violinsv}[6]{\violin{seevs}{SEE}{VSCode}{#1}{#2}{#3}{#4}{#5}{#6}}
\newcommand{\violinsus}{\violin{seevs-sus}{SEE}{VSCode}{sus}{ylabel=SUS}{40}{100}{7.4}{7.2153}}

\newcommand{\legendsquare}[1]{\textcolor{#1}{\rule{1.1ex}{1.1ex}}}


% TODO: Optional param (?) for ordinal data on Y axes
% TODO: Sign. difference => highlight somehow (maybe X label)
