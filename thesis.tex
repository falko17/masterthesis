...
% TODO: Maybe 1.064 or just 1 instead?
\usepackage[p,scaled=1.05]{erewhon}
\usepackage[scaled=1.05,proportional]{zlmtt}
...
\newcommand{\participants}{4\xspace}
...
\renewcommand\listoffixmes{%
	...
	\lettrine[lines=3]{\textcolor{Maroon}{O}}{pen} tasks/notes/mistakes for this master's thesis are collected within this appendix.
